...
class CreateObitoController {
    ...
    execute() {
        ...
        return async function (req, res) {
            let { name, freguesia, diafuneral, horafuneral, diamissa, horamissa, photo, funerariaid } = req.body
            ...
            const obito = await createObitoCommand.execute({ name, freguesia, diafuneral, horafuneral, diamissa, horamissa, photo, url, funerariaid })
